...
@Data
public class EntityCsq implements Serializable {
    //标记id字段
    @Id
    private ObjectId id;
    ...
    public EntityCsq(Long parameter1, String parameter2, Date parameter3, Integer parameter4, List<EntityTest1> parameter5) {
